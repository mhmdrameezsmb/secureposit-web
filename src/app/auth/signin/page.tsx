...
const SignIn = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      ...
      setLoader(true);
      const values = { username: data.email, password: data.password };
      ...
      if (res?.error) {
        ...
        ToastService.success("You've successfully logged In");
        setLoader(false);
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                ...
                {/* <img src="/images/icon/g.png" alt=""></img> */}

              </Link>

              <p className="2xl:px-20 text-3xl font-bold text-black whitespace-nowrap">
                Secure Posit Admin Panel
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <span>Please enter the details below to continue</span>
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                {!loader && (
                  <div className="mb-5">
                    <button
                      type="submit"
                      value="Sign In"
                      className="bg-mainBtn w-full cursor-pointer rounded-lg p-4 text-white transition hover:bg-opacity-90 g-btn"
                    >
                      Sign In
                    </button>
                  </div>
                ...
                >
                  <button
                    type="button"
                    className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-black text-white p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 "
                  >
                    Forgot password
                  </button>
                </Link>
