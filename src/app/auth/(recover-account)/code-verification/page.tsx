"use client";
import OtpInput from "@/app/auth/(recover-account)/code-verification/OtpInput/OtpInput";
...
const ForgotPasswordPage = () => {
    ...
    const handleDataReceived = async (data1: any) => {
        console.log("Data received in parent:", data1, search);
        ...
        if (!!error) {
            ...
            // console.log(data?.session_id, "s");
            router.push(`/auth/password-change?search=${search}`);
    ...
    const handleDataReceived2 = async (data1: any) => {
        console.log("resend");
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <OtpInput onDataReceived={handleDataReceived} onDataReceived2={handleDataReceived2} />
                    </div>
                </div>
            </div>
        </>
