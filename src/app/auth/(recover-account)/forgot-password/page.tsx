    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            if (!!error) {
                ...
                router.push(`/auth/code-verification?search=${data?.session_id}`);
                                ...
                                <div className="mb-5">
                                    {!loader && (
                                        <button
                                            type="submit"
                                            value="Sign In"
                                            className="bg-mainBtn w-full cursor-pointer rounded-lg border  p-4 text-white transition hover:bg-opacity-90 "
                                        >
                                            Submit
                                        </button>
                                    )}
