...
const List = () => {
  ...
  const headers = ["Sl.No", "Title", "Actions"];
  const limit = 5;
  ...
  return (
    <>
      ...
      <div className="rounded-lg border border-stroke bg-white    pt-3 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-5 xl:pb-1">
                      ...
                      <div className="flex items-center space-x-3.5">
                        <Tooltip content="Edit">
                          <button
                            ...
                            onClick={() => {
                              router.push(
                                `/content-management/pages/view/${item?.id}`
                              );
                            }}
                          >
                            <svg
